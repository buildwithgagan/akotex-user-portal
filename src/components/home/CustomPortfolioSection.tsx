  ...
  return (
    <section className="py-16 px-4 bg-white mb-0">
      <div className="max-w-7xl mx-auto">
        <div className="bg-akotex-red rounded-2xl overflow-hidden relative">
          <div className="flex flex-col md:flex-row items-center p-8 md:p-12">
            <div className="md:w-1/2 text-white mb-8 md:mb-0 z-10">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">Ready to Build Your Custom Portfolio?</h2>
              <p className="text-xl mb-8">It only takes 2 minutes to begin</p>
              <div className="flex flex-wrap gap-4">
                <Button asChild size="lg" className="bg-white text-akotex-red hover:bg-gray-100 font-bold">

...
const SignupPage = () => {
  ...
  const onSubmit = (data: SignupFormValues) => {
    ...
    toast.success("Account creation initiated", {
      description:
        "This is a demo. Account creation will be implemented later.",
    });
  };
        ...
        <div className="w-full max-w-md mx-auto">
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-muted-foreground mt-2 text-center">
              Enter your details to get started with Wealth Compass
            </p>
          </div>
          ...
          <div className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-gray-100">
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-muted-foreground">
                ...
                <Link
                  to="/login"
                  className="text-akotex-red hover:underline font-medium"
                >
                  Sign in
                </Link>
              </p>

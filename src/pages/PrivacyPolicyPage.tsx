  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <div className="prose prose-slate max-w-none">
        ...
        <p className="mb-4">
          At Akotex Investment LLC ("Company", "we", "our", "us"), we respect your privacy and are committed to protecting your personal data. This privacy policy will inform you how we look after your personal data when you visit our website and tell you about your privacy rights and how the law protects you.
        </p>
        ...
        <ul className="list-disc ml-8 mb-4">
          ...
          <li>Technical Data: internet protocol (IP) address, your login data, browser type and version</li>
        ...
        <p className="mb-4">
          ...
          New York, NY<br />
          Email: privacy@akotexwealth.com<br />

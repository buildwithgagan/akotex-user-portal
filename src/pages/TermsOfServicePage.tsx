  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <div className="prose prose-slate max-w-none">
        ...
        <p className="mb-4">
          Welcome to Akotex Investment LLC ("Company", "we", "our", "us"). These Terms of Service govern your use of our website located at www.akotexwealth.com and all related services provided by Akotex Investment LLC.
        </p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          All investments involve risk, and the past performance of a security, industry, sector, market, financial product, trading strategy, or individual's trading does not guarantee future results or returns. Investors are fully responsible for any investment decisions they make. Such decisions should be based on an evaluation of their financial circumstances, investment objectives, risk tolerance, and liquidity needs.
        </p>
        ...
        <p className="mb-4">
          You may not access or use the services for any illegal purpose or in violation of any local, state, national, or international law. You may not use our services:
        </p>
        <ul className="list-disc ml-8 mb-4">
          <li>To harass, abuse, or harm another person</li>
          <li>To impersonate another user or person</li>
          <li>To engage in any automated use of the system</li>
          <li>To attempt to bypass any security measures of the services</li>
          <li>To interfere with the proper working of the services</li>
        </ul>
        
        <h2 className="text-2xl font-semibold mt-8 mb-4">5. Intellectual Property</h2>
        <p className="mb-4">
          The service and its original content, features, and functionality are and will remain the exclusive property of Akotex Investment LLC and its licensors. The service is protected by copyright, trademark, and other laws of both the United States and foreign countries.
        </p>
        ...
        <p className="mb-4">
          In no event shall Akotex Investment LLC, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from your access to or use of or inability to access or use the service.
        </p>
        ...
        <p className="mb-4">
          Akotex Investment LLC<br />
          123 Financial District<br />
          New York, NY<br />
          Email: legal@akotexwealth.com<br />
